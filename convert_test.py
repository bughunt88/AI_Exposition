...
parser.add_argument('--img_path', type=str, help='directory of image folder', default="C:/data/task03_train/images/")
parser.add_argument('--label', type=str,
                    help='directory of label folder or label file path', default="C:/data/task03_train/labels.json")
parser.add_argument('--convert_output_path', type=str,
                    help='directory of label folder', default="C:/data/task03_train/labels/")
...
def main(config):
    ...
    if config["datasets"] == "VOC":
        ...
        print(coco.parse(config["label"], config["img_path"]))
